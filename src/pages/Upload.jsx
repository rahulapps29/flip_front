  ...
  return (
    <div className="upload-container">
      ...
      <form onSubmit={handleFileUpload} className="upload-form">
        ...
        {/* Upload Button */}
        <button type="submit" className="upload-file-btn" disabled={isUploading}>
      ...
      <div className="upload-instructions">
        ...
        <p className="instructions-text">
          Please upload a <strong>CSV file</strong> containing the following  <strong>(23 fields)</strong> fields given in the tables <strong>(13+10)</strong> below:- <br />
          <strong>All 23 fields must have headers</strong>, 'internetEmail' and 'managerEmailId' fields can not be blank and should be in proper meail format any other field may or may not have data.<br /> <strong>You can keep the last 10 fields as blank.</strong>
        ...
        <ul className="instructions-list">
          ...
          <li><strong>assetCondition</strong> - Asset (e.g., "Good", "bad ", "Need repairs", "HR")</li>
        </ul>

        <p className="instructions-subtitle">
          Field values entered by form user and system generated computed fields  ( last 10 fields )
        </p>
        ...
        <ul className="instructions-list">
          ...
          <li><strong>lastManagerEmailSentAt:</strong> System-generated timestamps showing the last time an email was dispatched (employee and manger in cc).</li>
        </ul>
