...
import { faTrash, faDownload, faSearch, faTimes, faEdit, faChevronLeft, faChevronRight, faEllipsisH, faUpload, faCheck } from '@fortawesome/free-solid-svg-icons';
...
const Dashboard = () => {
  ...
  const handleDeleteAll = async () => {
    ...
    setDialogMessage("Are you sure you want to delete ALL employee records? This action cannot be undone.⚠️");
    setDialogType("warning");
          ...
          {isModalOpen && selectedEmployee && (
            <div className="modal-overlay">
              <div className="modal-content">
                ...
                <h2>Trigger: {selectedEmployee.emailSent ? "Emp: Yes" : "Emp: No"} & {selectedEmployee.managerEmailSent ? "Mang: Yes" : "Mang: No"} </h2>
